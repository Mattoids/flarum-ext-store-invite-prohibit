...
namespace Mattoid\StoreInviteProhibit\Attributes;
...
UserAttributes
{
    ...
    public function __invoke(BasicUserSerializer $serializer, User $user) {
        ...
        $canViewButton = $actor->can('mattoid-store-invite-prohibit.group-view');
        $attributes['canInviteProhibitView'] = $canViewButton;
